...
export default {
  ...
  data() {
    return {
      backgroundColorMin: 180, // bg-min
      backgroundColorMax: 240, // bg-max
      contentWidth: 110, // 填充 w
      contentHeight: 45, // 填充 h
      colorMin: 50, // color
      colorMax: 160, // color
      fontSizeMin: 20,
      fontSizeMax: 40,
  ...
  methods: {
    ...
    // 改变文字
    drawText(ctx, txt, i) {
      ctx.fillStyle = this.randomColor(this.colorMin, this.colorMax); //图形填充颜色设置
      ctx.font =
